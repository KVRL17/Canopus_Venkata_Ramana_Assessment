    ...
    <div className="space-y-4 sm:space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-3 sm:p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xl sm:text-2xl font-bold text-gray-900">{userPosts.length}</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-lg border border-gray-200 p-3 sm:p-4">
      ...
      <div className="space-y-4">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-2 sm:space-y-0">
          ...
          <Link
            to="/create"
            className="inline-flex items-center justify-center space-x-2 bg-purple-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-md text-sm font-medium hover:bg-purple-700 transition-colors"
          >
